      ...
      <svg viewBox="60 78.75 581.25 562.5">
        <defs>
          ...
          >
            ...
            <stop
              offset="1"
              style={{ stopColor: "#ea3d01", stopOpacity: "0" }}
            />
          </radialGradient>
          <radialGradient
          ...
          >
            <stop
              offset="0"
              style={{ stopColor: "#fd6ef9", stopOpacity: "1" }}
            />
            <stop
              offset=".637"
              style={{ stopColor: "#f94", stopOpacity: "1" }}
            />
            <stop
              offset=".852"
          ...
          >
            <stop
              offset="0"
              style={{ stopColor: "#f8193e", stopOpacity: "1" }}
            />
            <stop
              offset=".939"
          ...
          >
            ...
            <stop
              offset="1"
              style={{ stopColor: "#e5495b", stopOpacity: "1" }}
            />
          </linearGradient>
          <linearGradient
