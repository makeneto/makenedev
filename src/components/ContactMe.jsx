...
const MessageContainer = styled.div`
    display: block;
    box-shadow: 0px 0px 2rem #0000000f;
    padding: 2rem 2.3rem;
    height: fit-content;
    border-radius: .6rem;
...
const MessageSubmitted = styled.div`
    display: block;
...
const BackButton = styled.button`
    background-color: transparent;
    color: ${({ obsolete }) => obsolete === 'true' ? 'var(--weak-green)' : 'var(--dark-green)'};
    padding: .6rem 1.4rem;
    font-size: 1rem;
    border-radius: .5rem;
    ...
    &:hover {
        background-color: ${({ obsolete }) => obsolete === 'false' && 'var(--weak-green)'};
    }
`;
                ...
                <MessageContainer>
                    ...
                    {sent ? (
                        <MessageSubmitted>
                            ...
                            <p>Your message is already on its way! If it's urgent, the answer can get quick, but if it takes a while, don't worry - sometimes the best answers need a little time to be written carefully. Meanwhile, relax, get a coffee or take the opportunity to review if there is something else you would like to add.We are here!😊📩</p>
                        </MessageSubmitted>
                    ) : (
                        <>
